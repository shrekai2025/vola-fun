...
export default function UserAPIListSection() {
  ...
  const handleTogglePublic = useCallback(
    async (apiId: string, currentPublic: boolean) => {
      try {
        setUpdating(apiId)
        await APIService.update(apiId, { is_public: !currentPublic })
  ...
  return (
    <div className='container mx-auto px-4 py-8'>
      ...
      <div className='flex items-center justify-between mb-8'>
        <div>
          <h1 className='text-3xl font-bold text-foreground mb-2'>{t('apiProvider.title')}</h1>
          <div className='flex items-center gap-2'>
            <p className='text-muted-foreground'>{t('apiProvider.description')}</p>
      ...
      loading ? (
        ...
        <div className='flex flex-col items-center justify-center min-h-[400px] text-center'>
          ...
          <h3 className='text-xl font-semibold text-foreground mb-2'>{t('apiProvider.noAPIs')}</h3>
          <p className='text-muted-foreground mb-6 max-w-md'>
                ...
                <div className='flex items-start justify-between'>
                  <div className='flex-1 min-w-0'>
                    ...
                    <div className='flex items-center gap-2 mt-2'>
                      <Badge variant='outline' className={`${getStatusStyle(api.status)} text-xs`}>
                  ...
                  <div className='flex-shrink-0'>
                    <Button
                      ...
                      title={
                        api.is_public ? t('toast.clickToSetPrivate') : t('toast.clickToSetPublic')
                      }
                    >
                      <span
