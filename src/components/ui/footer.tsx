...
export const Footer = ({ className = '' }: FooterProps) => {
  ...
  const sections = [
    ...
    },
    {
      ...
      links: [
        { 
          name: t.footer.language.english, 
          href: '#',
          onClick: () => changeLanguage('en'),
          active: language === 'en'
        },
        { 
          name: t.footer.language.chinese, 
          href: '#',
                    ...
                    <li key={linkIdx}>
                      {link.onClick ? (
                        ...
                        <Link
                          ...
                          target={link.href.startsWith('mailto:') ? undefined : link.external ? '_blank' : undefined}
