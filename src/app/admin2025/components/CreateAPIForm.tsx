...
export default function CreateAPIForm({ onClose, onSuccess }: CreateAPIFormProps) {
  ...
  const onSubmit = async (data: CreateAPIFormData) => {
    try {
      ...
      const _api = await APIService.create(apiData)
      ...
      toast.error(`发布API失败: ${(error as Error).message || '未知错误'}`)
    } finally {
        ...
        <CardContent className='pt-6'>
          <form onSubmit={handleSubmit(onSubmit)} className='space-y-6'>
              ...
              <div className='grid gap-4'>
                ...
                <div className='grid gap-4 md:grid-cols-2'>
                  ...
                  <div>
                    ...
                    <Input {...register('website_url')} placeholder='https://myweather.com' />
                  </div>
                </div>
                ...
                <div className='grid gap-4 md:grid-cols-2'>
                  ...
                  <div>
                    ...
                    <Input {...register('terms_url')} placeholder='https://myweather.com/terms' />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className='space-y-4'>
              ...
              <div className='grid gap-4 md:grid-cols-2'>
                <div>
                  <label className='text-sm font-medium text-foreground block mb-2'>网关密钥</label>
                  <Input
