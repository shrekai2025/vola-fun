...
// 设置认证弹窗状态
export const setAuthModalAtom = atom(
  null,
  (get, set, modalState: Partial<AuthModalState>) => {
...
// 打开认证弹窗
export const openAuthModalAtom = atom(
  null,
  (get, set, step: AuthModalState['step'] = 'email') => {
    set(authModalAtom, { isOpen: true, step })
  }
)

// 关闭认证弹窗
export const closeAuthModalAtom = atom(
  null,
  (get, set) => {
...
// 设置欢迎弹窗状态
export const setWelcomeModalAtom = atom(
  null,
...
export const setTokensAtom = atom(
  null,
  (get, set, tokens: StoredTokens | null) => {
